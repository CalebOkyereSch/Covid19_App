...
const GeneralInfo =()=>{
    ...
    return(
        <View style={{flex:1}}>
            <View style={{flex:1,backgroundColor:'#fff',justifyContent:'flex-end',marginLeft:10}}>
                <Text style={{fontSize:30,fontWeight:'600'}}>General Information</Text>
            </View>
            <View style={{flex:8}}>
                <ScrollView style={{paddingHorizontal:20,paddingVertical:10}}>
                    <Text>1.	1. Customer involvement; 2.  Maintain simplicity; 3. Incremental delivery; 4. Embrace change; 5. People not process.
...
15.	Ethnography is an observable technique that can be used to understand social and organization requirements. It helps analysts discover implicit system requirements that reflect the actual rather the formal processes in which people are involved 
16.	1. Small and medium sized software product development; 2. Custom software development in an organization where there is a clear commitment from the customer to become involved in the development process and where there are few external rules and regulations that affect the software.
17.	1. Project management process that encourages frequent inspection and adaptation; 2. Leadership philosophy that encourages teamwork, self-organization and accountability; 3. Development practice that allow for rapid delivery of high quality software; 4. Business approach that aligns development with customer needs and company goals.
18.	1. Requirements reviews; 2. Prototyping; 3. Test-case generation
19.	1. Customer involvement; 2. Incremental delivery; 3. People not process; 4. Maintain simplicity; 5. Embrace change
20.	User requirements are natural languages plus diagrams of the services the system provides and it operational constraints written for the customer 
System requirement is a structured document setting out detailed descriptions of the system’s functions, services and operational constraints
21.	1. What type of system is being developed; 2. Is an incremental delivery strategy realistic; 3. How is the development team organized; 4. Is the system subject to external regulations; 5. How large is the system that is being developed; 6. What is the expected system lifetime
22.	Functional requirements deal with the technical services to be provided and the non-functional requirements deals with the constraints on the services or functions
</Text>
                </ScrollView> 
            </View>
            <View style={{flex:1,justifyContent:'center'}}>
                <TouchableOpacity onPress={()=>signIn()} style={{marginHorizontal:30,height:40,backgroundColor:'#000',justifyContent:'center',alignItems:'center'}}>
                        <Text style={{color:"#fff",fontSize:11,fontWeight:"500"}}>Lets get started ...</Text>
                </TouchableOpacity>
            </View>
