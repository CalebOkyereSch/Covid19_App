            ...
            <ScrollView style={{flex:1,}}>
                <View style={{height:280,justifyContent:"flex-start"}}>
                    <ScrollView style={{flex:1}} horizontal={true}>
                            <HomeCard value="641" feeds="Confirmed Cases" pic={require('../assets/images/5.jpg')} />
                            <HomeCard value="241" feeds="Recovered"  pic={require('../assets/images/8.jpg')} />
                            <HomeCard value="8" feeds="Death"  pic={require('../assets/images/9.jpg')} />
                    </ScrollView>
                </View>
